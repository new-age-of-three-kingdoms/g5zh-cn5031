...
<section>
    <h2>新注册会员   [最新<?php echo $new_member_rows ?>名]</h2>
    <div class="local_desc02 local_desc">
        会员数量 <?php echo number_format($total_count) ?>个， 封号<?php echo number_format($intercept_count) ?>个, 删除: <?php echo number_format($leave_count) ?>个
    </div>

    <div class="tbl_head01 tbl_wrap">
        <table>
        <caption>新注册会员</caption>
        <thead>
        <tr>
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            else
            {
                ...
                $s_del = '<a href="javascript:del(\'./member_delete.php?'.$qstr.'&amp;w=d&amp;mb_id='.$row['mb_id'].'&amp;url='.$_SERVER['PHP_SELF'].'\');">删除</a>';
            }
        ...
        <tr>
            ...
            <td class="td_boolean"><?php echo $row['mb_mailling']?'是':'否'; ?></td>
            <td class="td_boolean"><?php echo $row['mb_open']?'是':'否'; ?></td>
            <td class="td_boolean"><?php echo preg_match('/[1-9]/', $row['mb_email_certify'])?'是':'否'; ?></td>
            <td class="td_boolean"><?php echo $row['mb_intercept_date']?'是':'否'; ?></td>
    ...
    <div class="btn_list03 btn_list">
        <a href="./member_list.php">查看所有会员</a>
    </div>
...
<section>
    ...
    <div class="btn_list03 btn_list">
        <a href="<?php echo G5_BBS_URL ?>/new.php">查看更多最新文章</a>
    </div>
</section>
...
<section>
    <h2>最新积分产生记录</h2>
    <div class="local_desc02 local_desc">
        合计<?php echo number_format($total_count) ?>条数据 [最新<?php echo $new_point_rows ?>条数据列表]
    </div>

    <div class="tbl_head01 tbl_wrap">
        <table>
        <caption>最新积分产生记录</caption>
        <thead>
        <tr>
            <th scope="col">会员ID</th>
            <th scope="col">姓名</th>
    ...
    <div class="btn_list03 btn_list">
        <a href="./point_list.php">查看所有积分记录</a>
    </div>
</section>
