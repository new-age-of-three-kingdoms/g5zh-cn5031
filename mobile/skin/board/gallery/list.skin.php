            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    if ($list[$i]['is_notice']) { // 公告 ?>
                        <strong style="width:<?php echo $board['bo_mobile_gallery_width'] ?>px;height:<?php echo $board['bo_mobile_gallery_height'] ?>px">公告</strong>
                    <?php
                    } else {
...
<fieldset id="bo_sch">
    ...
    <input name="stx" value="<?php echo stripslashes($stx) ?>" placeholder="关键词(必选项)" required id="stx" class="required" size="15" maxlength="20">
