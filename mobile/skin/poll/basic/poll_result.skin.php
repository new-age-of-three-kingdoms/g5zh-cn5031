...
<div id="poll_result" class="new_win">
    ...
    <section id="poll_result_cmt">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <?php if ($is_guest) { ?>
            <tr>
                <td><input type="text" name="pc_name" id="pc_name" class="frm_input required" required placeholder="姓名(必选项)"></td>
            </tr>
            <?php } ?>
            <tr>
                <td><input type="text" name="pc_idea" id="pc_idea" class="frm_input required" required maxlength="100" placeholder="评论(必选项)"></td>
            </tr>
            <?php if ($is_guest) { ?>
            <tr>
