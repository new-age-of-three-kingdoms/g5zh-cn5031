...
function captcha_html($class="captcha")
{
    ...
    $html .= "\n".'<legend><label for="captcha_key">验证码</label></legend>';
    if (G5_IS_MOBILE) $html .= '<audio src="#" id="captcha_audio" controls></audio>';
    //$html .= "\n".'<img src="#" alt="" id="captcha_img">';
    $html .= "\n".'<img src="javascript:void(0);" alt="" id="captcha_img">';
    if (!G5_IS_MOBILE) $html .= "\n".'<button type="button" id="captcha_mp3"><span></span>播放语音验证码</button>';
    ...
    $html .= "\n".'<span id="captcha_info">请输入验证码</span>';
    $html .= "\n".'</fieldset>';
    return $html;
}
